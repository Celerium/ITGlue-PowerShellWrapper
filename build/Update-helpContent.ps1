...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "ITGlue-PowerShellWrapper\docs"
        NO  - "ITGlue-PowerShellWrapper\ITGlueAPI\docs"

    Example: "C:\Celerium\Projects\ITGlue-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "ITGlue-PowerShellWrapper\docs"
    Reference:
        Yes - "ITGlue-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "ITGlue-PowerShellWrapper\ITGlueAPI\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\ITGlue-PowerShellWrapper\docs\Endpoints.csv"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the ITGlue API.'
...
ForEach ( $Cmdlet in $Commands ) {
    ...
    #$CsvData = $CSV | Where-Object {$_.Function -eq $Cmdlet.Name}
    ...
    $Method = $($CsvData.Method | Select-Object -Unique)
        ...
        #$Category
        #Set-Variable -Name Test_CSVData -Value $CsvData -Scope Global -Force
        #Set-Variable -Name Test_Category -Value $Category -Scope Global -Force
